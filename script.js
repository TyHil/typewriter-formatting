...
const names = ['input', 'charsOnLine', 'linesOnPage', 'marginChars', 'marginLines', 'columns', 'columnGap', 'wordBreak', 'charsToHyphen', 'addHyphen', 'file', 'transparency', 'center', 'lineSpacing', 'showSpaces', 'renderChar'];
